...
<%!
 ...
 String temp=null,yr2=null,hno1=null;
  %>
 <%
...
try
    {
	 %><br><br><center>
	 <pre><h5><table border="0"><thead><tr><td>Sno</td><td widht="20">   Student Name   </td><td>HallTicket No  </td></tr></thead><tbody></h5><font size=3 color=black><%

     stmt=con.createStatement();
     stmt1=con.createStatement(); 
    stmt2=con.createStatement();
		 qry="select fname,hno from student where baggregate >="+agg+"and branch like '"+br+"' and approved = '1' and s=0"; 
System.out.println("<<<<<>>>>>"+qry);
		 rs1=stmt2.executeQuery(qry);
	     while(rs1.next())
	       { j++;%> <tr><td valign="center"> <%out.println(++i);%></td><td><%
	          out.println("  "+rs1.getString(1)+" ");%></td><td valign="center"><%a=rs1.getString(2);out.println("  "+a+"  ");%></td><td><a href="cv1.jsp?id=<%=a%>">CV</a></td></tr><% 
	        }
