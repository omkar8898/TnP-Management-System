...
<body background="ob018.jpg"><%
 HttpSession ses=request.getSession();
  ...
  if(!(sid1.equals("NULL")))
	 {%>
 <center><h1><font color="2271A0">Update Statistics:</font></h1>
...
<td>Date</td> 
	...
	<td>
			<select name="m">
												<option selected value="JAN">1</option>
...
<tr><th>Company ID</th><th>Old</th><th>New</th></tr>
<%
 try
 {
...
<B><font size="3">
<tr><td><%=d%></td>  <td><%=e%></td> <td><input type="textbox" name=<%=d%> value=0   size=10></td></tr>
