...
<h5><center><table cellpadding="10px" border="0px"><thead><tr rowspan="3"><td></td><td><center>HallticketNO</td><td><center>Name</td><td><center>BTech</td><td><center>Inter</td><td><center>Matric</td><td><center>Approval</td></tr></thead><tbody></h5><br></center></pre>
<%@page import="java.sql.*"%>
<%!
 Statement stmt=null;
 ResultSet rs=null;
