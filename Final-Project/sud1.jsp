...
<%
   ...
   try
   {
	...
	rs=stmt.executeQuery("select hno,fname,branch,byear,baggregate,inter,tenth,day,month,year from student where                                                    hno='"+sid1+"'");
	while(rs.next())
           {%>
...
<table>
   ...
   <tr><td><font size="4">Year:</td></font>               <td><font size="4"><%=rs.getString(4)%></font></td></tr>   <tr><td><font size="4">B.Tech(agg):</td></font>        <td><font size="4"><%=rs.getString(5)%></font></td></tr>
